...
public class ViewStatServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (username == null) {
            ...
            Template template = ve.getTemplate("templates/viewStatBootstrap.html");

            context.put("title", "My Statistics");
            List<Item> productsHistory = dbHandler.getHistory(username);
            if (productsHistory == null || productsHistory.isEmpty()) {
                context.put("message","No products in your history to compute statistics.");
            }
            else {
